export const createProductCart=(products,parentElement,findProductInCart,pageType)=>{
        ...
        for(let product of products)
            {
                ...
                cartButton.setAttribute("data-id",product._id);
                    ...
                    buttonText.innerText=pageType==="cart" ? "Remove" : pageType==="products" && isProductInCart ? "Go to Cart" : "Add cart";
